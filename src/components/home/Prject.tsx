  ...
  return (
    <div className="my-12">
      ...
      <div className=" relative mt-20">
        ...
        <div className="grid md:grid-cols-4 relative  mx-auto justify-center gap-6 w-[90%] mx:w-[90%] xl:w-[80%] 2xl:w-[70%]">
          {/* //w-[80%] */}
          <div className="text-center py-10 shadow-xl shadow-top-right shadow-bottom-left .. transform hover:-translate-y-3 transition-transform duration-300 sm:w-[50%] w-[80%] md:w-[100%] lg:w-[100%] xl:w-[90%] 2xl:w-[100%] mx-auto">
            <img
          ...
          <div className="text-center py-12 shadow-xl shadow-top-right shadow-bottom-left .. transform hover:-translate-y-3 transition-transform duration-300 sm:w-[50%] w-[80%] md:w-[100%] lg:w-[100%] xl:w-[90%] 2xl:w-[100%] mx-auto">
            <img
          ...
          <div className="flex items-center">
            <div>
              ...
              <h1 className="text-[16px] ">
                ...
                detailed discussions with every individual involved in the
                project
              </h1>
              ...
              <h1 className="text-[16px] ">
                While maintaining exceptional quality, our rates remain below
                the industry average in Bangladesh. Additionally, we offer
              ...
              <div className=" ">
                ...
                <h1 className="text-[16px] relative">
                  ...
                  ensures the satisfaction of every customer, aiming to
                  establish another satisfied partnership. We anticipate that
                  you will become a long-term collaborator, mirroring the
                  enduring relationships we maintain with numerous clients over
                  the years
                </h1>
              </div>
            </div>
